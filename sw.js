const CACHE = "speelstad-v25";
const FILES = [
  "./", "index.html", "app.js", "farm.js", "bouw.js", "winkel.js", "vervoer.js", "manifest.webmanifest", "icon-180.png", "icon-192.png", "icon-512.png", "voices-index.json",
];
